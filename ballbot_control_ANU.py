...
def main():
    ...
    data_header = [
        ...
        "theta_x_filt", "theta_y_filt", # filtered IMU angles [rad]
    ...
    try:
        ...
        # Initialize filtered IMU angles
        theta_x_filt = 0.0
        theta_y_filt = 0.0
        alpha_lpf = 0.25  # Low-pass filter coefficient (tune between 0.1–0.4)
        ...
        while True:
            ...
            try:
                ...
                theta_x_filt = alpha_lpf * theta_x + (1 - alpha_lpf) * theta_x_filt
                theta_y_filt = alpha_lpf * theta_y + (1 - alpha_lpf) * theta_y_filt
                ...
                if control_mode == 0:
                    ...
                    # Ty = inner_pid_x.update(theta_d_x, theta_x_filt, derivative_measurement=dtheta_x)
                    # Tx = inner_pid_y.update(theta_d_y, theta_y_filt, derivative_measurement=dtheta_y)
