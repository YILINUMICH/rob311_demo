...
def calc_enc2rad(ticks):
    ...
    rad = ticks/N_GEARBOX/N_ENC*2*3.14159
    return rad
...
def main():
    ...
    try:
        ...
        data = ["i t_now Tx Ty Tz u1 u2 u3 psi_1 psi_2 psi_3 dpsi_1 dpsi_2 dpsi_3 phi_x phi_y phi_z"]
        dl.appendData(data)
        ...
        no_movement_start = None  # Track when the robot stops moving
        while True:
            time.sleep(DT)
