...
- DataLogger2's simple drop-in API (just change import)
- LP_pid_viewer's stable TCP-based PyQtGraph visualization

Author: Combines approaches from DataLogger2.py and LP_pid_viewer.py
"""
    ...
    if missing:
        ...
        if response == 'y':
            try:
                ...
                print("✓ Installation complete! Restart to use viewer.")
                return False
            except:
